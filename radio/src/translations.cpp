...
ISTR(VUSBJOYSTICK_MODE);
ISTR(VUSBJOYSTICK_CH);
...
const char STR_USBJOYSTICK_MODE[] = TR_USBJOYSTICK_MODE;
const char STR_USBJOYSTICK_CH_LABEL[] = TR_USBJOYSTICK_CH_LABEL;
const char STR_USBJOYSTICK_CH[] = TR_USBJOYSTICK_CH;
