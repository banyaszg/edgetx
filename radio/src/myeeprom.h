...
enum USBJoystickCh
{
  USBJOYS_CH_NONE,
  USBJOYS_CH_PUSHBTN,
  USBJOYS_CH_SWITCH_2S,
  USBJOYS_CH_SWITCH_3S,
  USBJOYS_CH_X_AXIS,
  USBJOYS_CH_Y_AXIS,
  USBJOYS_CH_Z_AXIS,
  USBJOYS_CH_RX_AXIS,
  ...
  USBJOYS_CH_DIAL,
  USBJOYS_CH_WHEEL,
  USBJOYS_CH_SIM_AILERON,
  USBJOYS_CH_SIM_ELEVATOR,
  USBJOYS_CH_SIM_RUDDER,
  USBJOYS_CH_SIM_THROTTLE,
  USBJOYS_CH_LAST SKIP = USBJOYS_CH_SIM_THROTTLE
};
